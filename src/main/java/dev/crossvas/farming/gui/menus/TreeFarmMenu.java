...
public class TreeFarmMenu extends AbstractContainerMenu implements IEnergyHolderMenu {

    public final TreeFarmBlockEntity TREE_FARM_TILE;
    public final Level level;
    public final ContainerData data;

    public TreeFarmMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(1));
    }

    public TreeFarmMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(CrossFarmingData.TREE_FARM_MENU.get(), id);
        checkContainerSize(inv, 2);
        TREE_FARM_TILE = (TreeFarmBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, TREE_FARM_TILE.getBlockPos()), player, CrossFarmingData.TREE_FARM_BLOCK.get());
    }
