...
public class CropFarmMenu extends AbstractContainerMenu implements IEnergyHolderMenu {

    public final CropFarmBlockEntity CROP_FARM_TILE;
    public final Level level;
    public final ContainerData data;

    public CropFarmMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(1));
    }

    public CropFarmMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(CrossFarmingData.CROP_FARM_MENU.get(), id);
        checkContainerSize(inv, 2);
        CROP_FARM_TILE = (CropFarmBlockEntity) entity;
...
//    }
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, CROP_FARM_TILE.getBlockPos()), player, CrossFarmingData.CROP_FARM_BLOCK.get());
    }
