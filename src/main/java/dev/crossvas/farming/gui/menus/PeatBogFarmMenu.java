...
import dev.crossvas.farming.blockentities.PeatBogFarmBlockEntity;
...
public class PeatBogFarmMenu extends AbstractContainerMenu implements IEnergyHolderMenu {

    public final PeatBogFarmBlockEntity PEAT_FARM_TILE;
    public final Level level;
    public final ContainerData data;

    public PeatBogFarmMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(1));
    }

    public PeatBogFarmMenu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(CrossFarmingData.PEAT_BOG_FARM_MENU.get(), id);
        checkContainerSize(inv, 5);
        PEAT_FARM_TILE = (PeatBogFarmBlockEntity) entity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, PEAT_FARM_TILE.getBlockPos()), player, CrossFarmingData.PEAT_BOG_FARM_BLOCK.get());
    }
